...
#    brown=cv2.inRange(hsv,brownMin,brownMax)  
    ...
    params.minArea = 500 #r=9px           # min 1000 pixels squared
        ...
        if len(centre) > 2:    
            ...
            if Xc>160+r:
                ...
                if Yc>120+r:
                    ...
                    print('Vx=',gnd_speed,'    Vy=', gnd_speed,'    Vz= 0')
                    print('2.Q (DRONE IS MOVING THROUG NORTH-WEST)')
                    ...
                    print('Vx=',gnd_speed,'    Vy=', gnd_speed,'    Vz= 0')
                    print('DRONE IS MOVING TROUGH WEST')
                ...
                if Yc>120+r:
                    ...
                    print('Vx=',gnd_speed,'    Vy=', gnd_speed,'    Vz= 0')
                    print('DRONE IS MOVING TROUGH SOUTH')
                    ...
                    print('Vx=',gnd_speed,'    Vy=', gnd_speed,'    Vz= 0')
                    print('DRONE IS MOVING TROUGH NORTH')
